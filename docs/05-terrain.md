...
- **Q109** ([QUESTIONS.md](QUESTIONS.md)): enemy paint as a remote fault injector — Q96's no-final-step-exemption plus Q97's free, global, cross-faction paint lets one brush stroke make a whole program color fault every loop.
