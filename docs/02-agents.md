...
| Survival | **Countdown** | ~20 s + **1 s per 100 total XP** (tuning, Q83) | total XP (built into the base formula) | The wreck's self-destruct timer: your rescue window, their salvage/analyze/hijack window. A rookie pops in ~20 s; a maxed veteran lingers ~2.5 extra minutes — the richest prizes give everyone the most time to fight over them. |
