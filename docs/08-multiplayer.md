...
- **PvP disconnects: free farm until reconnect.** No armistice, no auto-forfeit, no helm transfer. The colony keeps running autonomously and can be attacked like anything else — its defense is exactly whatever its owner programmed: `on hurt:` retreats, escort patrols, walls, alarm channels. Going offline is the ultimate exam of pillar 1; write code you'd trust alone at night.
